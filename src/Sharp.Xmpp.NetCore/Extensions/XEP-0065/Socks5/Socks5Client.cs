...
namespace Sharp.Xmpp.Extensions.Socks5
{
    ...
    internal class Socks5Client : IDisposable
    {
        ...
        /// <summary>
        /// Creates the specified hostname.
        /// </summary>
        ...
        /// <returns></returns>
        public static async Task<Socks5Client> Create(string hostname, int port, string username = null,
            string password = null)
        {
            var clt = new Socks5Client();
        ...
        /// <param name="password">The password.</param>
        /// <returns></returns>
        public async Task<Socks5Client> Create(IPAddress address, int port, string username = null,
            string password = null)
        {
            var clt = new Socks5Client();
